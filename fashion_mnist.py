...
#-------------------------LOADING DATASET,PREPROCESSING AND SPLITTING INTO TRAINING AND TESTING-----------------------------#
...
#------------------------------BUILDING CNN MODEL ARCHITECTURE USING SEQUENTIAL---------------------------------------------#
...
'''
UN-COMMENT THE BELOW BLOCK OF CODE TO TEST YOUR TRAINED MODEL ON SPECIFIC TEST IMAGES AND DISPLAYING THE RESULT
'''
...
'''
USE THE BELOW WRITTEN BLOCK OF CODE TO PREPROCESS ANY REAL WORLD FASHION IMAGE OF YOUR OWN AND MAKE PREDICTIONS BASED ON IT
'''
...
test_image=preprocess(None) # Add image path inplace of None
